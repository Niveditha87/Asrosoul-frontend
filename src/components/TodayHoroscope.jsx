...
import sunrice from "../assets/sunrice.jpg";
import { BiSun } from "react-icons/bi";
import { HiMoon } from "react-icons/hi";
import astrotalk2 from "../assets/astrotalk2.jpg";
        ...
        <div className="flex justify-between ml-24">
          <div className="ml-10">
            <div className="text-5xl font-semibold mt-16">
              <p>
                Today's <span className=" border-b-4">Horoscope</span>
              </p>
            </div>
            <div className="text-3xl mt-10">Check your today's horoscope</div>
          </div>
          <div>
            <img
              src={horoscope}
